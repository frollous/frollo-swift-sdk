        ...
        service.fetchUser { (result) in
            switch result {
                ...
                case .success(let userResponse):
                    ...
                    XCTAssertEqual(userResponse.currentAddress?.streetNumber, "100")
                    XCTAssertEqual(userResponse.currentAddress?.town, "Sydney")
                    XCTAssertEqual(userResponse.currentAddress?.postcode, "2060")
                    XCTAssertEqual(userResponse.currentAddress?.suburb, "North Sydney")
                    XCTAssertEqual(userResponse.mailingAddress?.unitNumber, "Unit 3, Level 33")
                    XCTAssertEqual(userResponse.mailingAddress?.streetName, "Mount")
                    XCTAssertEqual(userResponse.mailingAddress?.streetType, "street")
                    XCTAssertEqual(userResponse.mailingAddress?.longForm, "Frollo, Level 33, 100 Mount St, North Sydney, NSW, 2060, Australia")
        ...
        service.fetchUser { (result) in
            switch result {
                ...
                case .success(let userResponse):
                    ...
                    XCTAssertNil(userResponse.currentAddress?.postcode)
