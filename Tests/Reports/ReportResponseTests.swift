...
class ReportResponseTests: XCTestCase {
    ...
    func testReportResponse_BudgetCategory() {
        ...
        XCTAssertEqual(budgetCategoryGroupReport.value, Double(report.value) ?? 0)
    }
    ...
    func testReportResponse_Category() {
        ...
        XCTAssertEqual(category.value, Double(report.value) ?? 0)
    }
    ...
    func testReportResponse_Merchant() {
        ...
        XCTAssertEqual(merchant.value, Double(report.value) ?? 0)
    }
    ...
    func testReportResponse_Tag() {
        ...
        XCTAssertEqual(tag.value, Double(report.value) ?? 0)
    }
    ...
    func testReportResponse() {
        ...
        XCTAssertEqual(response.value, Double(report.value) ?? 0)
    }
}
