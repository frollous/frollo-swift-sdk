...
class UserTests: XCTestCase {
    ...
    func testUserModelUpdate() {
        ...
        database.setup { (error) in
            ...
            moc.performAndWait {
                ...
                XCTAssertEqual(userModel.address?.postcode, userResponseModel.address?.postcode)
                ...
                XCTAssertEqual(userModel.address?.streetName, userResponseModel.address?.streetName)
    ...
    func testUpdateUserRequest() {
        ...
        managedObjectContext.performAndWait {
            ...
            XCTAssertEqual(user.address?.buildingName, updateRequest.address?.buildingName)
