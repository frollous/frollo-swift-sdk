...
class UserTests: XCTestCase {
    ...
    func testUserModelUpdate() {
        ...
        database.setup { (error) in
            ...
            moc.performAndWait {
                ...
                XCTAssertEqual(userModel.currentAddress?.postcode, userResponseModel.currentAddress?.postcode)
                ...
                XCTAssertEqual(userModel.currentAddress?.streetName, userResponseModel.currentAddress?.streetName)
                XCTAssertEqual(userModel.mailingAddress?.country, userResponseModel.mailingAddress?.country)
                XCTAssertEqual(userModel.mailingAddress?.suburb, userResponseModel.mailingAddress?.suburb)
    ...
    func testUpdateUserRequest() {
        ...
        managedObjectContext.performAndWait {
            ...
            XCTAssertEqual(user.currentAddress?.buildingName, updateRequest.currentAddress?.buildingName)
            XCTAssertEqual(user.mailingAddress?.region, updateRequest.mailingAddress?.region)
