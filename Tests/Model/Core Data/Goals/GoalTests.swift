...
class GoalTests: XCTestCase {
    ...
    func testUpdatingGoal() {
        ...
        managedObjectContext.performAndWait {
            ...
            XCTAssertEqual(goalResponse.endDate, goal.endDate)
            XCTAssertEqual(goalResponse.estimatedEndDate, goal.estimatedEndDate)
            ...
            XCTAssertEqual(goalResponse.startDate, goal.startDate)
