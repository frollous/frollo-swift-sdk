...
public struct TransactionFilter {
    ...
    public var filterPredicates: [NSPredicate] {
        ...
        // Filter by goalID
        if let goalID = goalID, goalID != -1 {
            filterPredicates.append(NSPredicate(format: "\(#keyPath(Transaction.goalID)) == %@", argumentArray: [goalID]))
        }
    ...
    internal var urlString: String? {
        ...
        if let goalID = goalID {
            queryItems.append(URLQueryItem(name: "goal_id", value: String(goalID)))
        }
