...
extension APIService {
    ...
    internal func fetchTransactionSuggestedTags(searchTerm: String, sort: AggregationEndpoint.SortType = .name, order: OrderType = .asc, completion: @escaping RequestCompletion<[APITransactionTagResponse]>) {
