...
extension APIService {
    ...
    internal func deleteManagedProducts(productID: Int64, completion: @escaping NetworkCompletion) {
        requestQueue.async {
            ...
            self.network.sessionManager.request(url, method: .delete, encoding: JSONEncoding.default, headers: nil).validate(statusCode: 200...299).responseData(queue: self.responseQueue) { response in
