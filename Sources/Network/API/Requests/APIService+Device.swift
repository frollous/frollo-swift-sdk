...
extension APIService {
    ...
    internal func createLog(request: APIDeviceLogRequest, completion: @escaping NetworkCompletion) {
        requestQueue.async {
            ...
            self.network.sessionManager.request(urlRequest).validate(statusCode: 200...299).responseData(queue: self.responseQueue, emptyResponseCodes: [204, 205, 201]) { response in
