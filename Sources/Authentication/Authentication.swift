    ...
    */
    public func loginUserUsingWeb(presenting presentingViewController: UIViewController, additionalParameters: [String: String]? = nil, completion: @escaping FrolloSDKCompletionHandler) {
        ...
        let request = OIDAuthorizationRequest(configuration: config,
                                              clientId: clientID,
                                              clientSecret: nil,
                                              scopes: [OAuthTokenRequest.Scope.offlineAccess.rawValue, OIDScopeOpenID, OIDScopeEmail, OIDScopeProfile, OIDScopeAddress],
    ...
    public func loginUser(email: String, password: String, completion: @escaping FrolloSDKCompletionHandler) {
        ...
        let scopes = [OAuthTokenRequest.Scope.offlineAccess.rawValue, OIDScopeOpenID, OIDScopeEmail, OIDScopeProfile, OIDScopeAddress].joined(separator: " ")
